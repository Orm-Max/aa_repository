...
def plot_results(results):
    ...
    plt.plot(sizes, times_s, 's-', color='darkorange', linewidth=2, markersize=8)
    plt.xlabel('Number of Nodes (n)', fontsize=12)
    plt.ylabel('Time (s)', fontsize=12)
    plt.title('DFS Performance (Depth-First Search)', fontsize=14, fontweight='bold')
...
if __name__ == "__main__":
    ...
    print("DFS Measurement Results:")
    print("=" * 45)

    results = measure_dfs(size_values)
